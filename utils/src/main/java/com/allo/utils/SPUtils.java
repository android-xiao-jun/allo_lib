...
public class SPUtils {
    ...
    public static SPUtils with() {
        return with("", Context.MODE_PRIVATE);
    }
     ...
     * @return the single {@link SPUtils} instance
     */
    public static SPUtils with(final int mode) {
        return with("", mode);
    }
    ...
    public static SPUtils with(String spName) {
        return with(spName, Context.MODE_PRIVATE);
    }
     ...
     * @return the single {@link SPUtils} instance
     */
    public static SPUtils with(String spName, final int mode) {
        if (isSpace(spName)) spName = "common";
